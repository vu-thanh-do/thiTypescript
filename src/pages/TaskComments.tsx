...
const TaskComments: React.FC = () => {
      ...
      const mockComments: CommentItem[] = [
        {
          id: "1",
          content:
            "Tôi đã bắt đầu làm việc trên task này. Cần thêm thông tin về yêu cầu màu sắc.",
          author: "Alice",
        ...
        },
        {
          id: "2",
          content:
            "Màu sắc chủ đạo nên sử dụng xanh dương và trắng, phù hợp với nhận diện thương hiệu.",
          author: "Admin",
  ...
  if (!task) {
    return <Empty description="Không tìm thấy thông tin task" />;
  }
        ...
        <Space direction="vertical" style={{ width: "100%" }} size="large">
          <div>
            ...
            <div style={{ marginTop: 8 }}>
              <Badge
                status="processing"
                text={<Text strong>{task.title}</Text>}
              />
